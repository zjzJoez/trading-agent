...
- In `BEAR_TREND`, your bias should default to bearish or neutral — don't manufacture bullish setups.
- In `VOLATILE_TRANSITION`, mark `setup_quality` as ≤0.5.
- If 1D gap > 5% pre-open, flag `chase_risk: true`.
