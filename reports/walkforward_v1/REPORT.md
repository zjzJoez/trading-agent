...
> **Superseded 2026-05-17:** This run, like v2 and v3, used the buggy
> binary-feature × full-covariance setup where hmmlearn aborted EM at
> iter 3. The "no detectable signal" conclusion below happens to be
> consistent with the v4 properly-fit result (no Sharpe edge), but the
> specific numbers were produced by a broken model and should not be
> cited. See `../walkforward_v4_converged/REPORT.md` for the trustworthy
> evaluation.
